...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.room = [[0 for j in range(width)] for i in range(height)]
        self.cleanedTitles = 0
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    """
    totalTime = 0.0
    requiredCleanedTile = width * height * min_coverage
    ...
    for trial in range(num_trials):
        ...
        while room.getNumCleanedTiles() < requiredCleanedTile:
